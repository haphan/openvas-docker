...
# Default-Stop:      0 1 6
# Short-Description: remote network security auditor - manager
# Description:       The Open Vulnerability Assessment System is a modular
#                    security auditing tool, used for testing remote systems
#                    for vulnerabilities that should be fixed.
### END INIT INFO
...
do_stop()
{
	...
	# sleep for some time.
	start-stop-daemon --stop --quiet --oknodo --retry=0/TERM/30/KILL/5 --exec $DAEMON
	[ "$?" = 2 ] && return 2
